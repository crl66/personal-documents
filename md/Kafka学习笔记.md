...
![image-20200916093856262](https://gitee.com/Intercrl/img/raw/master/img/image-20200916093856262.png)

* 系统解耦
	* 原先一个微服务是通过接口（HTTP）调用另一个微服务，这时候耦合很严重，只要接口发生变化就会导致系统不可用
	* 使用消息队列可以将系统进行解耦合，现在第一个微服务可以将消息放入到消息队列中，另一个微服务可以从消息队列中把消息取出来进行处理。进行系统解耦

![image-20220325133545981](https://gitee.com/Intercrl/img/raw/master/img/image-20220325133545981.png)

* 流量削峰
	* 因为消息队列是低延迟、高可靠、高吞吐的，可以应对大量并发

![image-20200916093919754](https://gitee.com/Intercrl/img/raw/master/img/image-20200916093919754.png)

* 日志处理
	* 可以使用消息队列作为临时存储，或者一种通信管道

![image-20200916093933994](https://gitee.com/Intercrl/img/raw/master/img/image-20200916093933994.png)
